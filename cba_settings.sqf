...
Achilles_var_BLU_ION_lxWS = true;
Achilles_var_BLU_NATO_lxWS = true;
Achilles_var_BLU_T_F = true;
Achilles_var_BLU_TURA_lxWS = true;
Achilles_var_BLU_UN_lxWS = true;
...
Achilles_var_gm_fc_ca_bgs = true;
...
Achilles_var_gm_fc_uk_civ = true;
...
Achilles_var_IND_ION_lxWS = true;
Achilles_var_IND_L_F = true;
Achilles_var_IND_SFIA_lxWS = true;
Achilles_var_IND_TURA_lxWS = true;
Achilles_var_IND_UN_lxWS = true;
Achilles_var_Interactive_F = true;
Achilles_var_NLD_Units = true;
Achilles_var_NLD_Units_CTRGNL = true;
...
Achilles_var_Achilles_ACE_ImmersiveHeal_Module = false; 
...
force WBK_DeathAnimMod_Death_Chance = "30";
...
force WBK_DeathAnimMod_Hit_Chance = "60";
...
force grad_trenches_functions_shortEnvelopeDigTime = 12;
...
force lambs_main_radioBackpack = 1000; 
force force lambs_main_radioDisabled = false; 
force lambs_main_radioEast = 250; 
force lambs_main_radioGuer = 250; 
force lambs_main_radioShout = 50; 
force lambs_main_radioWest = 250; 
