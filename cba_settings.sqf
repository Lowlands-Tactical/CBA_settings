...
// LAMBS Danger
force lambs_danger_combatShareRange = 60;
...
force lambs_danger_radio_backpack = 500;
lambs_danger_radio_disabled = false;
force lambs_danger_radio_EAST = 100;
force lambs_danger_radio_GUER = 100;
force lambs_danger_radio_shout = 60;
force lambs_danger_radio_WEST = 100;
